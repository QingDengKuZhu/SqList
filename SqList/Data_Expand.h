...
/*返回顺序线性表的前驱元素.若v是顺序线性表的数据元素,且不是第一个,则用*e返回它的前一个元素,函数返回OK;否者函数返回FALSE, *e无定义*/
STATUS PriorELem(PSQLIST pL, int v, int *pre_e);

/*返回顺序线性表的后驱元素.若v是顺序线性表的数据元素,且不是第最后个,则用*e返回它的后一个元素,函数返回OK;否者函数返回FALSE, *e无定义*/
